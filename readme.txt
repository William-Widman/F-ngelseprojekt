...
## Beskrivning
Det här är ett textbaserat äventyrsspel där spelaren måste navigera genom en labyrint, lösa utmaningar och hitta utgången innan deras drag tar slut. Spelet är interaktivt och innehåller olika typer av utmaningar som gåtor, fällor och matematiska pussel.

---

## Spelregler
1. **Mål:** Hitta utgången genom att navigera mellan rum i labyrinten.
2. **Drag:** Du har **20 drag** på dig att klara spelet.
...
1. **Navigera**: Spelaren väljer en riktning att gå genom att skriva kommandon som `rakt fram`, `höger` eller `vänster`.
2. **Utmaningar**:
